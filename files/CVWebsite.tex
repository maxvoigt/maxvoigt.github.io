...
\section{Working Papers} 	
	\sectionline
    \textbf{Investor Beliefs and Asset Prices Under Selective Memory} (\href{http://maxvoigt.github.io/files/Voigt25_BeliefsAssetPrices.pdf}{Available here}) \\
...
\section{Presentations} 	
	...
	\vspace{-3ex}
    \begin{nstabbing}
	2025 \qquad \qquad \qquad \= German Economists Abroad, EEA 2025, CEAR-RSI Household Finance \\
	 \>  Workshop (discussion), Cognitive Foundations in Finance,  SITE Asset Pricing, \\ 
	 \> Helsinki Finance Summit, HEC-McGill Winter Finance Workshop (discussion)\\[0.5ex]
...
\section{Awards} 	
	...
	\vspace{-3ex}
    \begin{nstabbing}
    2025 \qquad \qquad \qquad \= Best paper award at the Workshop on Cognitive Foundations in Finance \\[0.5ex]
    2024 \> The Brattle Group Ph.D. Award for Outstanding Research, WFA \\[0.5ex]
...
\section{Teaching Experience}
	...
	\vspace{-3ex}
    \begin{nstabbing}
    Since 2025 ~ \qquad \quad \= \textbf{Instructor} \\
...
\sectionline
\vspace{-3ex}
\begin{nstabbing} % We need parbox for automatically wrapping the text
	\parbox[t]{\linewidth}{European Economic Review, International Journal of Forecasting, 
	Journal of Behavioral and Experimental Finance, Management Science}
\end{nstabbing}
